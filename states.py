...
class States(object):
    ...
    def __init__(
        ...
        self.r = redis.Redis(host=redis_host, port=redis_port, db=0, decode_responses=True, connection_pool=connection_pool)
    ...
    def dx_callsign(self) -> str:
        return self.r.get(self.redis_key('dx_callsign')) or ''
    ...
    def dx_grid(self) -> str:
        return self.r.get(self.redis_key('dx_grid')) or ''
    ...
    @property
    def mode(self) -> str:
        return self.r.get(self.redis_key('mode')) or ''
