...
def process_wsjt(_data: bytes, ip_from: tuple, states: States):
    ...
    if isinstance(packet, wsjtx.WSHeartbeat):
        ...
        if isDoneTransmitting:
            ...
            if states.transmitter_started:
                ...
                if result.get('nextTx', 'R73') == matched.get('type', None):
                    ...
                    if states_list['transmit_counter'] >= result.get('max_transmit_count', (states_list['aggresive_level']+2)*states_list['max_tries']):
                        states.change_states(
                            tries = 0,
                            inactive_count = 0,
                            transmit_counter = 0
        ...
        additional_data = {
            ...
            'max_transmit_count': (states_list['aggresive_level']+2)*states_list['max_tries'],
        ...
        if data['isVIPDXCC']:
            ...
            data['max_transmit_count'] = (states_list['aggresive_level']+2)*MAX_TRIES_VIP
